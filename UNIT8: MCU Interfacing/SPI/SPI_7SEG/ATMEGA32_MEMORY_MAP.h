...
//REGISTERS
#define SPI_SPCR    (*(vuint32_t *)(IO_BASE + 0x0D))      //SPCR – SPI Control Register
#define SPI_SPSR    (*(vuint32_t *)(IO_BASE + 0x0E))      //SPSR – SPI Status Register 
#define SPI_SPDR    (*(vuint32_t *)(IO_BASE + 0x0F))      //SPDR – SPI Data Register
